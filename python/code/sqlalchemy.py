...
engine = create_engine('postgresql://localhost:postgres@127.0.0.1:5432')
...
# Create the table using the metadata attribute of base class
Base.metadata.create_all(engine)

#SQLAlchemy SESSIONS

Session give you access to Transactions, whereby on success
